...
GST_STATES: dict[str, str] = {
    ...
    "23": "Madhya Pradesh", "24": "Gujarat", "26": "Dadra and Nagar Haveli and Daman and Diu",
...
GST_STATE_NAMES_TO_CODES = {name.casefold(): code for code, name in GST_STATES.items()}
GST_STATE_NAMES_TO_CODES.update({"nct of delhi": "07", "orissa": "21", "pondicherry": "34"})
